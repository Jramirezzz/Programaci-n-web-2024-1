...
export function Footer(){
    return(
      <footer>
       ...
       <div>
        <img src="https://images.ctfassets.net/x7j9qwvpvr5s/2CsA99p11kL3UvzN4txafd/832dabdc0d00a62a43fe559933a46c35/Ducati-Member-of-the-Audi-Group.svg" alt="Ducati logo"/>
        <p>TERMS OF USE</p>
        <p>INFORMACION DE PRIVACIDAD</p>
        <p>INFORMACION SOBRE LAS COOKIES</p>

        <p>Copyright © 2024 Ducati Motor Holding S.p.A – A Sole Shareholder Company - A Company subject to the Management and Coordination activities of AUDI AG. All rights reserved. VAT 05113870967</p>
