        ...
        <div className="SecondFooter">
          <img style={{width:"600px", paddingTop:"80px", paddingBottom:"80px"}} src="https://images.ctfassets.net/x7j9qwvpvr5s/2CsA99p11kL3UvzN4txafd/832dabdc0d00a62a43fe559933a46c35/Ducati-Member-of-the-Audi-Group.svg"alt="Ducati logo"/>
            ...
            <div className="SocialIcons">
              <img className="Imagen" src="https://images.ctfassets.net/x7j9qwvpvr5s/56kY1dy4ZO93CxK2Di9itU/5769a9e357351b930a7fee9c38ad818d/logo-scrambler.svg" />
              <img className="Imagen"src="https://images.ctfassets.net/x7j9qwvpvr5s/mAPUX0tvcEr7aWnAvURML/fdadaff5825970b1cf4152a383b09c6b/Scrambler-configurator-icon.svg"/>
              <img className="Imagen"src="https://images.ctfassets.net/x7j9qwvpvr5s/ZWRckIEnlpmIyRjTWROL8/d9cf76987e3b376aaa8ecd81159c8de1/fb-icon.svg"/>
              <img className="Imagen" src="https://images.ctfassets.net/x7j9qwvpvr5s/4f48hkC0Lm5qMRHrOT8WwV/63c89f535e32ec23ec3b5dc94ad3de64/twitter-icon.svg" />
              <img className="Imagen" src="https://images.ctfassets.net/x7j9qwvpvr5s/5rfCVoq7TMPwjeeig77b9S/19a9c2f929c2e990790e4ff4cee614b3/instagram-icon.svg" />
              <img className="Imagen" src="https://images.ctfassets.net/x7j9qwvpvr5s/sAz4OhE7CJoOW6d3EzPym/4873db418d8aa82f9d14b411b9f52c67/yt-icon.svg"/>
              <img className="Imagen" src="https://images.ctfassets.net/x7j9qwvpvr5s/JFrSj1zkgM3piads06CSE/8658ad49ce47062b15b9af7eb4b3b49a/linkedin-icon.svg"/>
            </div>
        </div>
      </div>
   </footer>
